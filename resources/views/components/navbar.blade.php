<nav class="fixed top-0 left-0 w-full px-6 py-6 bg-transparent z-40">
    ...
    <button id="burger" class="md:hidden text-whitePrimary focus:outline-none text-3xl z-40">
      ☰
        ...
        <!-- Mobile Menu -->
        <div id="mobileMenu" class="md:hidden hidden absolute top-full left-0 w-full bg-[#1e1e1e] bg-opacity-95 px-6 py-6 text-center">
        <ul class="flex flex-col gap-6">
            ...
            <li>
            <a href="#contact" class="bg-blackPrimary text-whitePrimary rounded-full px-6 py-3 font-medium hover:bg-zinc-700 transition inline-block">
                Contact Us
            </a>
            </li>
        </ul>
