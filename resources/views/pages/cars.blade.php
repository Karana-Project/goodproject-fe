        ...
        <div class="relative z-20 flex items-center h-full">
            <div class="w-full max-w-screen mx-[10px] md:mx-[80px] flex md:justify-end px-6 py-6">
                <div class="text-center md:text-right w-full max-w-[1000px]">
                    <h1 class="text-whitePrimary text-4xl md:text-6xl font-bold mb-2 md:mb-4 uppercase">Tempat Mobil Istimewa
                        Menemukan Pemilik Baru</h1>
                    <p class="text-whitePrimary font-light text-lg md:text-xl mb-6">Jual beli mobil mewah jadi lebih mudah,
        ...
        <div class="bg-whitePrimary rounded-3xl p-10 shadow-md">
            ...
            <div class="flex flex-col md:flex-row items-center md:items-center text-center md:text-left mt-10">
                ...
                <div class="flex flex-col sm:flex-row gap-6 md:gap-12 md:w-2/3 items-center justify-end w-full">
                    ...
                    <div
                        ...
                        <p class="text-blackSecondary text-sm md:text-base">Pilihan Mobil</p>
                    </div>
                    ...
                    <div
                        ...
                        <p class="text-blackSecondary text-sm md:text-base">Pelanggan Puas</p>
                    </div>
            ...
            <div class="mt-6 md:mt-8 flex justify-end flex flex-col md:flex-row items-center">
                <p class="text-blackSecondary text-sm md:text-base text-center md:text-left max-w-3xl mx-auto md:mx-0">
                    Temukan mobil bekas dan modifikasi istimewa yang telah teruji kualitasnya. Setiap unit kami lolos
                    inspeksi menyeluruh untuk menjamin performa, keamanan, dan kenyamanan Anda di jalan. Nikmati
                    fleksibilitas pembayaran tunai, kredit, hingga tukar tambah. Biar kami yang antarkan mobil impian Anda
                    langsung ke lokasi dengan layanan towing khusus, menjadikan proses pembelian lebih praktis dan
                    terpercaya.
                </p>
            </div>
                        ...
                        <div class="swiper-wrapper">
                            @for ($i = 0; $i < 5; $i++)
                                <div class="swiper-slide">
                                    <x-car-card image="images/hero-images-1.jpg" name="Porsche 911" brand="Porsche"
                                        year="2024" km="6000" transmission="Automatic" seats="2"
                                        price="2000000000"
            ...
            <div class="w-full mt-20 md:px-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="bg-whitePrimary rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-200">
                        <h3 class="text-blackPrimary text-xl font-bold uppercase mb-1">Temukan Mobil Impian Anda</h3>
                    ...
                    <!-- Card 2 -->
                    <div class="bg-whitePrimary rounded-xl p-6 shadow-md hover:shadow-lg transition-shadow duration-200">
                        <h3 class="text-blackPrimary text-xl font-bold uppercase mb-1">Jual atau Tukar Tambah</h3>
                        <p class="text-blackSecondary text-sm mb-14">
                ...
                <div class="flex flex-col md:flex-row items-end md:justify-between md:text-left mb-8">
                    <div>
                        ...
                        <p class="text-blackSecondary text-sm md:text-base mb-8">
                            Experience top-tier car care with our premium wash and detailing services. We meticulously
                            clean, polish, and protect every inch of your vehicle—inside and out.
                        </p>
                    ...
                    <div class="w-full md:w-1/3 flex flex-col gap-4">
                        ...
                        <div class="h-[140px] md:h-[190px] rounded-xl overflow-hidden shadow-md">
                            <iframe class="w-full h-full"
                                src="https://www.youtube.com/embed/_uHKUnALQXI?si=JoHrcIkIsNDBw2vB" title="YouTube video"
                                frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowfullscreen>
                            </iframe>
                        ...
                        <div class="h-[140px] md:h-[190px] rounded-xl overflow-hidden shadow-md">
                            <iframe class="w-full h-full"
                                src="https://www.youtube.com/embed/_bZY4Z1cDFA?si=MoGORBWK-VIw9PDO" title="YouTube video"
                                frameborder="0"
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                                allowfullscreen>
                            </iframe>
